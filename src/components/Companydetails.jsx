  ...
  const handleLogoChange = (e) => {
    ...
    <>
        ...
        <div className="Cdetails" style={{background:"white", padding:"1.7rem"}}>
                    <h4 style={{color:"black", background:"white", fontSize:"1.7rem", fontWeight:"700"}}>Company Details*</h4>
                    ...
                    <div style={{padding:"2rem"}}>
                        ...
                        <InputField type="text" text="Company Name" placeholder="Invoicely Inc"/>
